...
class GreenletTracer(object):
    ...
    def _calculate_loadavgs(self):
        # Calculate a "load average" in the same way the Linux kernel does.
        # I.e., an exponentially-damped moving average of the number of
        # greenlets that are waiting to run.
